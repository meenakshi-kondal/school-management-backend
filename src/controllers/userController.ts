...
import { getUserClasses, assignment, workAlreadyAssigned, getAssignment, userProfile } from "../services/userService";
...
export const profile = async(req: Request, res: Response) => {
	...
	try {
		...
		const isUserExist = await userProfile(payload.id, payload.role);
		if(!isUserExist) {
